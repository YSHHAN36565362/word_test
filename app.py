...
def render_sidebar() -> list:
    ...
    학습/연습/시험이 진행되는 동안(focus 모드)에는 호출되지 않는다.
    """
    with st.sidebar:
...
def render_study_active() -> None:
    """진행 중에는 제목/설명/파일 선택 UI를 모두 숨기고 필요한 것만 맨 위에 보여준다."""
...
# ---------------------------
# 7. 연습 파트 (망각 곡선 적용, 설정 화면 / 진행 중 화면 분리)
# ---------------------------
...
# ---------------------------
# 9. UI - 단어장 추가 파트 (항상 전체 화면으로 표시, focus 모드 없음)
# ---------------------------
...
# ---------------------------
# 10. 지문 한 줄 외우기 파트 (설정 화면 / 진행 중 화면 분리)
# ---------------------------
