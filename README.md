...
| 8 | 初めての人向けの説明がない | 設定画面に、パート別機能と便利機能をアコーディオンで確認できる使い方ガイドを追加 |
...
![設定 — 使い方ガイド](./images/app-10-usage-guide.png)

設定画面の一番上で、パート別の機能と便利機能(この学習をもう一度、単語の順番を
シャッフル、学習記録の管理、マイ番号、キーボードショートカット)をアコーディオンで
開いて確認できます。初めて訪れた人もアプリを触る前に何ができるか先に確認できるように
...
src/
  app/
    ...
    more/                        # その他メニュー、設定(マイ番号・テーマ・使い方ガイド・学習記録管理)
    api/
  ...
  components/                    # FileSelector, FlashCard(3Dフリップ), Mascot, SessionInfoPanel, UsageGuide など
...
| 8 | 처음 쓰는 사람을 위한 안내가 없음 | 설정 화면에 파트별 기능과 편의 기능을 아코디언으로 확인할 수 있는 사용법 안내 추가 |
...
![설정 — 사용법](./images/app-10-usage-guide.png)
